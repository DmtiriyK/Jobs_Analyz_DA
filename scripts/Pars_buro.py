...
keywords = [
    "Büroleiter", "Office-Manager", "Office Manager", "Büro Manager",
    "Büromanagement", "Büroassistenz", "Office Administrator",
    "Office Coordinator", "Verwaltungsmitarbeiter", "Office Assistant",
    "Büroangestellter", "Executive Assistant", "Team Assistant",
...
results_batch = []
total = len(jobs_list)
output_file = 'raw_qa_buro_germany.csv'
